package frc.lib2539.logging;

import edu.wpi.first.networktables.*;
import frc.lib2539.logging.LogValue.LoggableType;
      ...
      case Raw:
        subscriber =
            NetworkTableInstance.getDefault()
                .getRawTopic(key)
                .subscribe(type.getNT4Type(), new byte[0]);
        break;
      case Boolean:
        subscriber = NetworkTableInstance.getDefault().getBooleanTopic(key).subscribe(false);
        break;
      case Integer:
        subscriber = NetworkTableInstance.getDefault().getIntegerTopic(key).subscribe(0);
        break;
      case Float:
        subscriber = NetworkTableInstance.getDefault().getFloatTopic(key).subscribe(0);
        break;
      case Double:
        subscriber = NetworkTableInstance.getDefault().getDoubleTopic(key).subscribe(0);
        break;
      case String:
        subscriber = NetworkTableInstance.getDefault().getStringTopic(key).subscribe("");
        break;
      case BooleanArray:
        subscriber =
            NetworkTableInstance.getDefault().getBooleanArrayTopic(key).subscribe(new boolean[0]);
        break;
      case IntegerArray:
        subscriber =
            NetworkTableInstance.getDefault().getIntegerArrayTopic(key).subscribe(new long[0]);
        break;
      case FloatArray:
        subscriber =
            NetworkTableInstance.getDefault().getFloatArrayTopic(key).subscribe(new float[0]);
        break;
      case DoubleArray:
        subscriber =
            NetworkTableInstance.getDefault().getDoubleArrayTopic(key).subscribe(new double[0]);
        break;
      case StringArray:
        subscriber =
            NetworkTableInstance.getDefault().getStringArrayTopic(key).subscribe(new String[0]);
        break;
    }
  }
