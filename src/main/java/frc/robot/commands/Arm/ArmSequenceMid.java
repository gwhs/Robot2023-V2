...
public class ArmSequenceMid {
  ...
  public ArmSequenceMid(MagicMotion m, BoreEncoder b, BoreEncoder c, Claw clawP) {
    this.mainArm = m;
    this.shaftEncoder = b;
    this.clawEncoder = c;
    ...
    return new SequentialCommandGroup(
        Commands.either(
            Commands.sequence(
                ...
                new MagicMotionPos(mainArm, 210.0, 2.75, 8.5, 1),
                Commands.waitSeconds(.25),
            ...
            Commands.sequence(
                ...
                // Commands.waitSeconds(.25),
                Commands.runOnce(mainArm::resetPosition, mainArm),
                new MagicMotionPosShuffleboard(mainArm, 215, 2.75, 3, shaftEncoder),
                Commands.waitSeconds(.25),
                new MagicMotionPos(mainArm, 10, 3, 1.5, .5),
                new MagicMotionAbsoluteZero(mainArm, shaftEncoder, 5, 2.5),
                // new ClawEncoderMoveUp(0, clawPivot, clawEncoder, "Cube"),
