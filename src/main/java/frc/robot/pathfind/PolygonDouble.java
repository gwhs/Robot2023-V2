...
public class PolygonDouble implements Shape, Cloneable, Serializable {
  ...
  /**
   * The array of <i>x</i> coordinates. The value of {@link #npoints npoints} is equal to the number
   * of points in this <code>Polygon2D</code>.
   */
   ...
   * @throws IndexOutOfBoundsException if <code>npoints</code> is greater than the length of <code>
   *     xpoints</code> or the length of <code>ypoints</code>.
   * @throws NullPointerException if <code>xpoints</code> or <code>ypoints</code> is <code>null
   *     </code>.
   */
   ...
   * @return <code>true</code> if the <code>Polygon</code> contains the <code>Point</code>; <code>
   ...
   * @return <code>true</code> if this <code>Polygon</code> contains the specified <code>Point2D
   ...
   * @return <code>true</code> if this <code>Polygon</code> and the interior of the specified <code>
   *     Rectangle2D</code> intersect each other; <code>false</code> otherwise.
   */
  ...
  /**
   * Tests if the interior of this <code>Polygon</code> entirely contains the specified <code>
   * Rectangle2D</code>.
   *
   * @param r the specified <code>Rectangle2D</code>
   * @return <code>true</code> if this <code>Polygon</code> entirely contains the specified <code>
   ...
   * SEG_LINETO, and SEG_CLOSE point types are returned by the iterator. Since polygons are already
...
class Polyline2D implements Shape, Cloneable, Serializable {
  ...
  /**
   * The array of <i>x</i> coordinates. The value of {@link #npoints npoints} is equal to the number
   * of points in this <code>Polyline2D</code>.
   */
  public double[] xpoints;
   ...
   * coordinate arrays from before the reset are reused, creating a new empty <code>Polyline2D
   * </code> might be more memory efficient than resetting the current one if the number of vertices
   * in the new polyline data is significantly smaller than the number of vertices in the data from
   * before the reset.
   */
  public void reset() {
    npoints = 0;
   ...
   *
   * <p>If an operation that calculates the bounding box of this <code>Polyline2D</code> has already
  ...
  /**
   * Gets the bounding box of this <code>Polyline2D</code>. The bounding box is the smallest {@link
  ...
  /**
   * Determines if the specified coordinates are inside this <code>Polyline2D</code>. This method is
   * required to implement the Shape interface, but in the case of Line2D objects it always returns
   ...
   * This method is required to implement the Shape interface, but in the case of Line2D objects it
   * always returns false since a line contains no area.
   */
  public boolean contains(Point2D p) {
    return false;
  ...
  /**
   * Tests if the interior of this <code>Polyline2D</code> entirely contains the specified <code>
   * Rectangle2D</code>. This method is required to implement the Shape interface, but in the case
