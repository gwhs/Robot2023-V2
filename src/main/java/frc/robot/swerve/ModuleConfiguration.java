 ...
 * Swerve Drive Specialties Mk4 swerve module has four gear configurations, and therefore should
 * have multiple configurations ({@link ModuleConfiguration#MK4_L1} and {@link
 * ModuleConfiguration#MK4_L2}, for example).
 */
