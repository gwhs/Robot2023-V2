...
public class MagicMotion extends SubsystemBase {
  ...
  public void robotInit() {
    ...
    testTalon.configSelectedFeedbackSensor(
    ...
    testTalon.setStatusFramePeriod(
        StatusFrameEnhanced.Status_13_Base_PIDF0, 10, Constants.Arm.kTimeoutMs);
    testTalon.setStatusFramePeriod(
        StatusFrameEnhanced.Status_10_MotionMagic, 10, Constants.Arm.kTimeoutMs);
  ...
  public void setAng(double angle, double vel, double accel) {
    ...
    testTalon.configMotionCruiseVelocity(vel / 360. * 2048. * 64. * 10, Constants.Arm.kTimeoutMs);
    testTalon.configMotionAcceleration(accel / 360. * 2048. * 64. * 10, Constants.Arm.kTimeoutMs);
